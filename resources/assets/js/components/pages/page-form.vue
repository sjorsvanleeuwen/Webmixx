<template>
    <form method="post" :action="httpUrl">
        ...
        <div class="form-group">
            <label for="page_template_id">Page Template</label>
            <select disabled="disabled" id="page_template_id" name="page_template_id" v-model="page.page_template_id" class="form-control ">
                <option value="" disabled="disabled">Please Select</option>
                <option v-for="page_template in page_templates" :value="page_template.id" v-text="page_template.name"></option>
            </select>
        </div>
        <page-attribute-template v-for="pageAttributeTemplate in rootPageAttributeTemplates" v-bind:key="pageAttributeTemplate.id" :page-attribute-template="pageAttributeTemplate" :page-template="pageTemplate" />
        <div class="form-group">
...
export default {
    ...
    computed: {
        ...
        pageTemplate() {
            return _.find(this.page_templates, {
                id: this.page.page_template_id,
            });
        },
